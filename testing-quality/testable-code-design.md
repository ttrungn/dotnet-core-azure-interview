...
### 1. What does Testable Code Design improve in a .NET codebase?

**Answer:** Testable code design keeps dependencies explicit, side effects isolated, and business decisions easy to exercise. The value is fast feedback and lower regression risk. Explain what defect it catches and how it helps developers change code safely.
