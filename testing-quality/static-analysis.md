...
Static analysis checks code without running the application.

- **Style rules:** Formatting and naming consistency.
- **Correctness rules:** Nullability, unused code, risky patterns, and complexity.
- **Security rules:** Secret detection, injection risks, and unsafe APIs.
- **Maintainability rules:** Complexity, duplication, and code smells.
- **CI integration:** Fail builds for serious issues before merge.

Example: nullable reference warnings can catch a possible null customer email before the code reaches production.
...
### 1. What does Static Analysis improve in a .NET codebase?

**Answer:** Static analysis catches style, correctness, security, and maintainability issues automatically before runtime. The value is fast feedback and lower regression risk. Explain what defect it catches and how it helps developers change code safely.
