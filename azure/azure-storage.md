...
### 1. What production problem does Azure Storage solve in a .NET application?

**Answer:** Azure Storage provides blobs, queues, tables, and files for durable cloud storage scenarios. The production problem is usually hosting, scaling, messaging, storage, secrets, telemetry, deployment, or reliability. A strong answer ties the service to one workload and one operational risk.
